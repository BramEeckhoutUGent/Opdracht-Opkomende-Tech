// Ik zal eerst proberen om 1 GIF te laten afspelen, daarna zal ik per GIF een kleine apart scriptje schrijven
// Later kan ik dan in de hoofdcode gewoon verwijzen naar elk scriptje

// Code gehaald van een GitHub paginan en tutorial op Youtube gekeken
